...
public class PlaceChooseActivity extends AppCompatActivity implements LocationSource,
    ...
    Inputtips.InputtipsListener inputtipsListener = new Inputtips.InputtipsListener() {
        ...
        public void onGetInputtips(List<Tip> list, int rCode) {
            if (rCode == AMapException.CODE_AMAP_SUCCESS) {// 正确返回
                ...
                Toast.makeText(PlaceChooseActivity.this, "erroCode " + rCode, Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    private void initView() {
        ...
        searchResultAdapter = new SearchResultAdapter(PlaceChooseActivity.this);
        ...
        searchText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (newText.length() > 0) {
                    ...
                    Inputtips inputTips = new Inputtips(PlaceChooseActivity.this, inputquery);
//                    inputquery.setCityLimit(true);
    ...
    private void setUpMap() {
        ...
        mLocationStyle.myLocationType(MyLocationStyle.LOCATION_TYPE_LOCATE);//LOCATION_TYPE_LOCATION_ROTATE_NO_CENTER LOCATION_TYPE_LOCATE
...
//        Log.i("MY", "geoAddress"+ searchLatlonPoint.toString());
    ...
    public void onRegeocodeSearched(RegeocodeResult result, int rCode) {
        ...
        if (rCode == AMapException.CODE_AMAP_SUCCESS) {
            ...
            Toast.makeText(PlaceChooseActivity.this, "error code is " + rCode, Toast.LENGTH_SHORT).show();
        }
    }
...
//        Log.i("MY", "doSearchQuery");
        currentPage = 0;//inputSearchKey
        query = new PoiSearch.Query(inputSearchKey, searchType, "");// 第一个参数表示搜索字符串，第二个参数表示poi搜索类型，第三个参数表示poi搜索区域（空字符串代表全国）
        query.setCityLimit(true);    //今天修改
            ...
            if (poiResult != null && poiResult.getQuery() != null) {
                if (poiResult.getQuery().equals(query)) {
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        ...
                        Toast.makeText(PlaceChooseActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
                    }
                }
            } else {
                Toast.makeText(PlaceChooseActivity.this, "无搜索结果", Toast.LENGTH_SHORT).show();
