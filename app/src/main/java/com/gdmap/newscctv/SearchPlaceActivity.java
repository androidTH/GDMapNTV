...
import com.gdmap.newscctv.overlay.PoiSearchOverlay;
...
public class SearchPlaceActivity extends AppCompatActivity implements
    ...
    private void showSuggestCity(List<SuggestionCity> cities) {
        ...
        ToastUtil.show(SearchPlaceActivity.this, infomation);
            ...
            if (result != null && result.getQuery() != null) {// 搜索poi的结果
                if (result.getQuery().equals(query)) {// 是否是同一条
                    ...
                    if (poiItems != null && poiItems.size() > 0) {
                        mAMap.clear();// 清理之前的图标
                        PoiSearchOverlay poiOverlay = new PoiSearchOverlay(mAMap, poiItems);
                        ...
                        ToastUtil.show(SearchPlaceActivity.this,
                                R.string.no_result);
                    }
                }
            } else {
